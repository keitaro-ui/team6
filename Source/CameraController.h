...
private:
	...
	float					maxAngleX = DirectX::XMConvertToRadians(20);
	...
	DirectX::XMFLOAT3 moveForward{ 0,0,1 }; // 初期前方向ベクトル
	bool moveForwardInitialized = false;
